  ...
  return (
    <div className="bg-base-100 p-8 rounded-xl shadow-sm border border-base-300">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-2xl font-bold text-base-content">Donor Profile</h3>
        {profileId && (
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="form-control">
            <label className="label font-bold text-base-content">Age *</label>
            <input
              type="number"
          ...
          <div className="form-control">
            ...
            {errors.blood_group && <span className="text-error text-sm mt-1">{errors.blood_group.message}</span>}
          </div>
        </div>

        <div className="form-control">
          <label className="label font-bold text-base-content">Last Donation Date</label>
          <input
            type="date"
            max={today}
          ...
          />
          {errors.last_donation_date && <span className="text-error text-sm mt-1">{errors.last_donation_date.message}</span>}
          <p className="text-sm text-base-content/50 mt-2">Leave blank if you have never donated before.</p>
        </div>
