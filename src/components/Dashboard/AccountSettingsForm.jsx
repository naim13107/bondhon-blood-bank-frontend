...
const AccountSettingsForm = ({ userDetails, tokens }) => {
  ...
  return (
    <div className="bg-base-100 p-8 rounded-xl shadow-sm border border-base-300">
      <h3 className="text-2xl font-bold text-base-content mb-6">Account Settings</h3>

      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        <div className="form-control">
          <label className="label font-bold text-base-content">Email Address</label>
          <input
            type="email"
            className="input input-bordered w-full bg-base-200 text-base-content/50"
            readOnly
            {...register("email")}
          />
          <p className="text-xs text-base-content/40 mt-1">Email cannot be changed directly for security reasons.</p>
        </div>
        ...
        <div className="form-control">
          <label className="label font-bold text-base-content">Address</label>
          <input
            type="text"
        ...
        <div className="form-control">
          <label className="label font-bold text-base-content">Phone Number</label>
          <input
            type="text"
            className="input input-bordered w-full"
