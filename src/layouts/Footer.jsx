    ...
    <footer className="footer sm:footer-horizontal bg-base-300 text-base-content p-10">
      <aside className="flex flex-col items-start gap-2">
        <div className="flex items-center text-red-600 font-bold text-xl">
            <Droplet className="h-6 w-6 mr-2 fill-current" />
            Bondhon
        </div>
      ...
      <nav>
        <h6 className="footer-title text-red-600 opacity-100">Services</h6>
        <Link to="/requests" className="link link-hover">Find Blood</Link>
        <Link to="/register" className="link link-hover">Donate Now</Link>
        <Link to="/add-request" className="link link-hover">Emergency Request</Link>
        <Link to="/health-tips" className="link link-hover">Health Tips</Link>
      </nav>

      <nav>
        <h6 className="footer-title text-red-600 opacity-100">Organization</h6>
      ...
      <nav>
        <h6 className="footer-title text-red-600 opacity-100">Social</h6>
